...
client.on("message", msg =>{
  let emmbed = new Discord.MessageEmbed()
    ...
    .setDescription(`My Default Prefix is : -\nDo \`-help\` To Get Help Page\nDo \`-invite\` To invite me to server And gain members\n\n\`Support\`: **__[Support Server](https://discord.gg/qgv3SsX)__** | **__[Invite The Bot](https://discord.com/oauth2/authorize?client_id=733311503813443636&scope=bot&permissions=2146958847)__**`)
    .setFooter(client.user.username)
  if(msg.content === `<@733311503813443636>`){
