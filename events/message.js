...
module.exports = {
  execute: async (client, message, prefix, db) => {
    ...
    if (data.banned == true && message.author.id !== "694847203054714971" && message.author.id !== "694847203054714971") return message.channel.send(`${message.author.username} kiddo you're banned from this bot.`)
