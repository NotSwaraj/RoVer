...
if (logs === null) logs = []
logs.unshift(`[+1] - Voted Inviter+ Bot in Discord Bot List.`)
          ...
          embeds: [
            {
              author: {
                name: `New Vote:`,
                icon_url: client.users.cache.get(user).displayAvatarURL(), //`https://cdn.discordapp.com/attachments/657989418749263872/662378425956171786/IMG_20200102_202611.jpg`
              },
              description: `${client.users.cache.get(user).tag} Thanks for voting for ${client.user.username}, I rewarded you with 1 coins.`,
              color: 15878608
            }
          ]
        })
